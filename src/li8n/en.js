export default {
  ...
  //Global Header
  must_loggedIn: 'You must be open your wifi to access the app.',
  ...
  profile_server: 'Your Places',
  no_restaurant: 'You have no place at the moment',
  search_rest: 'Search for your place and add yourself by choosing',
  you_waiter: 'Add staff',
  ind_rest: 'Search for more places',
  ...
  waitress: 'Waitress',
  modif_prof: 'I modify my candidate profile',
  monday: 'Monday',
  tuesday: 'Tuesday',
  wednesday: 'Wednesday',
  thursday: 'Thursday',
